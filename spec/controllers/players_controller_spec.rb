  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved player as @player" do
        ...
        post :create, {:player => { "given_name" => "invalid value" }}, valid_session
        assigns(:player).should be_a_new(Player)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested player" do
        ...
        Player.any_instance.should_receive(:update_attributes).with({ "given_name" => "MyString" })
        put :update, {:id => player.to_param, :player => { "given_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the player as @player" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Player.any_instance.stub(:save).and_return(false)
        put :update, {:id => player.to_param, :player => { "given_name" => "invalid value" }}, valid_session
        assigns(:player).should eq(player)
      end
